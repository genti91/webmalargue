...
export const formatCotizacionData = (form, bultos) => {
  ...
  return {
    ...
    sucursalCanalizadoraNombre: form?.sucursalOrigenNombre,
    sucursalCanalizadoraDomicilio: form?.sucursalOrigenDomicilio,
    sucursalDestino: form?.sucursalDestino,
    sucursalDestinoNombre: form?.sucursalDestinoNombre,
    sucursalDestinoDomicilio: form?.sucursalDestinoDomicilio,
