  ...
  return (
    <div className={`tw-flex tw-flex-col tw-items-start tw-justify-center tw-gap-2 tw-w-full ${zipCode && 'md:tw-max-w-[158px]'}`}>
      ...
      <input
        ...
        className={`${zipCode && 'md:tw-max-w-[158px]'} ${email && 'tw-max-w-[537px]'} tw-border tw-border-[#2F3394] tw-placeholder-[#B3B3B3] tw-rounded-lg tw-p-2 tw-w-full focus:tw-outline-none tw-bg-[#FFFFFF] tw-px-4`}
        required={mandatory}
        aria-label={title}
      />
    </div>
